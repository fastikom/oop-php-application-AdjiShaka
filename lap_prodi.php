...
<html>
<head>
	<title>Laporan Data Prodi</title>
</head>
...
<a href="#" class="w3-border-bottom w3-large w3-text-teal"> Lihat Data</a>
  ...
  <a href="lap_prodi.php" class="w3-light-grey w3-medium">Program Studi</a>
</nav>
...
<div id="myTop" class="w3-top w3-container w3-padding-hor-16 w3-theme w3-large">
  ...
  <span id="myIntro" class="w3-hide">Sistem Akademik: Data Program Studi</span>
</div>

<header class="w3-container w3-theme w3-padding-hor-64 w3-padding-ver-64">
  <h1 class="w3-xxxlarge w3-padding-hor-16">Sistem Akademik: Data Program Studi</h1>
</header>

<div class="w3-container w3-padding-hor-32 w3-padding-ver-64">
  <div class="w3-container w3-padding-hor-64 w3-text-teal ">
  <a class="w3-btn-floating-large w3-teal " href="in_prodi.php">+</a>
    <table width="225" border="1" class="w3-table w3-bordered w3-striped w3-border">
      ...
      $show = $Lib->tampildata();
		...
		<tr>
			<td><?php echo "$urut"?></td>
			<td><?php echo "$hasil[kd_prodi]"?></td>
			<td width="300"><?php echo "$hasil[prodi]"?></td>
      <td><a class='w3-btn w3-teal' href='lap_prodi.php?delete=<?php echo "$hasil[kd_prodi]"?>'>Delete</a></td>
      <td><a class='w3-btn w3-blue-grey' href='edit_prodi.php?kode=<?php echo "$hasil[kd_prodi]"?>'>Edit</td>
		</tr>
		<?php } ?>
	</table>
</div>
